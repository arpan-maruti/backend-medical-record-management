...
// Routes
router.get("/",passport.authenticate('jwt', { session: false }), roleMiddleware(['admin']), getUsers);
router.get("/:id", passport.authenticate('jwt', { session: false }), roleMiddleware(['user','admin']),getUserByIdController);
